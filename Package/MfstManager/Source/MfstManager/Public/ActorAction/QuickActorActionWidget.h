...
struct FRandomActorRotation
{
	GENERATED_BODY()
	/* Yaw */
	UPROPERTY(EditAnywhere,BlueprintReadWrite,Category = "RandomRotation")
	bool bRotYaw = false;

	UPROPERTY(EditAnywhere,BlueprintReadWrite,meta = (EditCondition = "bRotYaw"),Category = "RandomRotation")
	...
	UPROPERTY(EditAnywhere,BlueprintReadWrite,meta = (EditCondition = "bRotPitch"),Category = "RandomRotation")
	...
	UPROPERTY(EditAnywhere,BlueprintReadWrite,meta = (EditCondition = "bRotRoll"),Category = "RandomRotation")
